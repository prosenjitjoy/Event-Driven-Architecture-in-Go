...
func (h IntegrationEventHandlers[T]) onOrderCreated(ctx context.Context, event ddd.AggregateEvent) error {
	...
	return h.publisher.Publish(ctx, orderingpb.OrderAggregateChannel, ddd.NewEvent(orderingpb.OrderCreatedEvent, &orderingpb.OrderCreated{
...
func (h IntegrationEventHandlers[T]) onOrderReadied(ctx context.Context, event ddd.AggregateEvent) error {
	...
	return h.publisher.Publish(ctx, orderingpb.OrderAggregateChannel, ddd.NewEvent(orderingpb.OrderReadiedEvent, &orderingpb.OrderReadied{
		Id:         event.AggregateID(),
		CustomerId: payload.CustomerID,
		PaymentId:  payload.PaymentID,
		Total:      payload.Total,
...
func (h IntegrationEventHandlers[T]) onOrderCanceled(ctx context.Context, event ddd.AggregateEvent) error {
	...
	return h.publisher.Publish(ctx, orderingpb.OrderAggregateChannel, ddd.NewEvent(orderingpb.OrderCanceledEvent, &orderingpb.OrderCanceled{
		Id:         event.AggregateID(),
		CustomerId: payload.CustomerID,
		PaymentId:  payload.PaymentID,
	}))
...
func (h IntegrationEventHandlers[T]) onOrderCompleted(ctx context.Context, event ddd.AggregateEvent) error {
	...
	return h.publisher.Publish(ctx, orderingpb.OrderAggregateChannel, ddd.NewEvent(orderingpb.OrderCompletedEvent, &orderingpb.OrderCompleted{
		Id:         event.AggregateID(),
		CustomerId: payload.CustomerID,
