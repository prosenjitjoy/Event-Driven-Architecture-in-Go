...
func RegisterCatalogHandlers(subscriber ddd.EventSubscriber[ddd.AggregateEvent], catalogHandlers ddd.EventHandler[ddd.AggregateEvent]) {
	subscriber.Subscribe(catalogHandlers,
